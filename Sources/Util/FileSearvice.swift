            ...
            if let fileType = attribute[.type] as? FileAttributeType {
                ...
                case .typeDirectory:
                    ...
                    while let relativePath = enumerator?.nextObject() as? String {
                        ...
                        if relativePath.contains(regex: ".build/") {
                            continue
                        }
                        if relativePath.contains(regex: ".swiftpm/") {
                            continue
                        }
                        if relativePath.contains(regex: "Carthage/") {
                            continue
                        }
                        if relativePath.contains(regex: "Pods/") {
                            continue
                        }
                        if relativePath.contains(regex: ".xcodeproj/") {
                            continue
                        }
                        if relativePath.contains(regex: ".xcworkspace/") {
                            continue
                        }
